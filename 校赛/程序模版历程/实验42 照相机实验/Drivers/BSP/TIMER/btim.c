...
{
    g_timx_handler.Instance = BTIM_TIMX_INT;                /* 通用定时器X */
    g_timx_handler.Init.Prescaler = psc;                    /* 设置预分频器 */
    ...
    HAL_TIM_Base_Start_IT(&g_timx_handler);                 /* 使能通用定时器x和及其更新中断：TIM_IT_UPDATE */
}
