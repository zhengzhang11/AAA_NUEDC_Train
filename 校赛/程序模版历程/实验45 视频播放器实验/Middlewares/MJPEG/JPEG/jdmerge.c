...
//  outptr = output_buf[0];
  ...
  for (col = cinfo->output_width >> 1; col > 0; col--) {
    ...
    y  = GETJSAMPLE(*inptr0++);
//    outptr[RGB_RED]   = range_limit[y + cred];   //修改
...
//    outptr0[RGB_RED]   = range_limit[y + cred];   //修改
...
//    y  = GETJSAMPLE(*inptr01++);
//    outptr1[RGB_RED]   = range_limit[y + cred];   //修改
//    outptr1[RGB_GREEN] = range_limit[y + cgreen];
//    outptr1[RGB_BLUE]  = range_limit[y + cblue];
//    outptr1 += RGB_PIXELSIZE;
//    y  = GETJSAMPLE(*inptr01++);
...
//    upsample->spare_row = (JSAMPROW) (*cinfo->mem->alloc_large)   //修改
