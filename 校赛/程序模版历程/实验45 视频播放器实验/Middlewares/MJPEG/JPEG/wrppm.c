...
{
//  ppm_dest_ptr dest = (ppm_dest_ptr) dinfo;   //修改

//  (void) JFWRITE(dest->pub.output_file, dest->iobuffer, dest->buffer_width);  //修改
}
...
{
  /* Emit file header */
//  switch (cinfo->out_color_space) {   //修改
//  case JCS_GRAYSCALE:
...
{
//  /* Make sure we wrote the output file OK */    //修改
