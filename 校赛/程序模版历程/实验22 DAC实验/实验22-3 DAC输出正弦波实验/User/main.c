...
int main(void)
{
    ...
    while (1)
    {
        ...
        adcx = adc_get_result_average(ADC_ADCX_CHY, 20);    /* 得到ADC通道5的转换结果 */
        temp = (float)adcx * (3.3 / 4096);                  /* 得到ADC电压值(adc是162it的) */
        adcx = temp;
